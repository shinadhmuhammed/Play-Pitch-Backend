...
userRouter.post('/turfrating', jwtUser_1.default.verifyJwtUser, UserController_1.default.getTurfRating);
...
userRouter.post("/getTurfAverageRating", jwtUser_1.default.verifyJwtUser, UserController_1.default.getTurfAverageRating);
userRouter.post("/nearestTurf", jwtUser_1.default.verifyJwtUser, UserController_1.default.nearestTurf);
